...
class AsyncFunc: public AsyncObjBase
{
    FUNC Func;
    tuple<ARGS...> tup;
    public:
    AsyncFunc( FUNC func, ARGS ... args)
    {
        Func = func; 
        tup =  tuple<ARGS...>(args...);
    }
...
template<class FUNC, class ... ARGS>
void AsyncRunFunc(FUNC func, ARGS&&... args)
{
     __ASYNCWORKERS.Add(new AsyncFunc<FUNC, ARGS...>(func, args...));
}

template<class FUNC, class ... ARGS>
void AsyncRunFunc( DoneState & done, FUNC func, ARGS &&... args)
{
    auto asyncobject = new AsyncFunc<FUNC, ARGS&&...>(func, args...);
	(*asyncobject).SetWaiter(done);
    __ASYNCWORKERS.Add(asyncobject);
}

template<class DONESTATEQUEUE, class FUNC, class ... ARGS>
void AsyncRunFunc(DONESTATEQUEUE & donequeue, FUNC func, ARGS&&... args)
{
   auto asyncobject = new AsyncFunc<FUNC, ARGS...>(func, args...);
	(*asyncobject).SetWaiter(donequeue.Create());
     __ASYNCWORKERS.Add(asyncobject);
